...
NEW_ROWS = [
    ...
    ("TBT ML-250", "TBT Tiefbohr-Technik", "CNC deep hole drilling machine", "Drilling",
     1550, 100, 1000, None,
    ...
    ("TBT B3S", "TBT Tiefbohr-Technik", "Horizontal BTA deep hole drilling machine", "Drilling",
     15000, 200, 20000, None,
    ...
    ("TBT BW300", "TBT Tiefbohr-Technik", "Table deep hole drilling/boring machine", "Drilling|Boring",
     2000, 76, 20000, None,
    ...
    ("TOS WHN 13 CNC", "TOS Varnsdorf", "Horizontal boring mill", "Boring",
     2000, 1800, 12000, None,
    ...
    ("TOS WHN 110", "TOS Varnsdorf", "Horizontal boring mill", "Boring",
     2000, 1400, 8000, None,
    ...
    ("MATRIX 37 CNC", "Matrix Machine Tool", "CNC universal thread grinder", "Thread Grinding",
     508, 355, 100, None,
    ...
    ("MATRIX 47 Type 1", "Matrix Machine Tool", "Heavy-duty universal thread grinder", "Thread Grinding",
     1066, 355, 200, None,
    ...
    ("MATRIX THW-3080", "Matrix Machine Tool", "CNC worm thread grinding machine", "Thread Grinding",
     800, 300, 80, None,
    ...
    ("SCHENCK HM2", "Schenck RoTec", "Horizontal balancing machine", "Balancing",
     1600, 360, 50, None,
    ...
    ("SCHENCK HM4", "Schenck RoTec", "Horizontal balancing machine", "Balancing",
     1750, 1600, 1500, None,
    ...
    ("SCHENCK HM40", "Schenck RoTec", "Horizontal balancing machine", "Balancing",
     1750, 1600, 3000, None,
     "https://www.directindustry.com/prod/schenck-rotec-gmbh/product-14345-423556.html",
    ...
    ("WHEELABRATOR WS-4/210", "Wheelabrator", "Spinner-hanger shot blast machine", "Shot Blasting",
     1000, 635, 900, None,
    ...
    ("WHEELABRATOR CT-2-45/7-430", "Wheelabrator", "Continuous through-feed shot blast machine", "Shot Blasting",
     700, 700, 250, None,
...
def main():
    ...
    for r in range(2, ws.max_row + 1):
        ...
        ws.cell(r, row_index("Capability notes")).value = (
            "CNC lathe; supports threading, taper turning and grooving."
        )
        lathe_updated += 1
